...
const events: Event[] = [
  {
    ...
    tz: "UTC",
    start_at_utc: BASE_SECONDS + 3_600,
    end_at_utc: BASE_SECONDS + 7_200,
    rrule: undefined,
    exdates: undefined,
    reminder: 900,
    created_at: BASE_SECONDS,
  ...
  },
  {
    ...
    end_at_utc: BASE_SECONDS + 20_700,
    rrule: undefined,
    exdates: undefined,
    reminder: 600,
    created_at: BASE_SECONDS,
  ...
  },
  {
    ...
    tz: "America/New_York",
    start_at_utc: BASE_SECONDS + 21_600,
    end_at_utc: BASE_SECONDS + 25_200,
    rrule: undefined,
    exdates: undefined,
    reminder: 600,
    created_at: BASE_SECONDS,
...
for (let index = 0; index < 60; index += 1) {
  const start = BASE_SECONDS + 86_400 + index * 3_600;
  events.push({
    id: `evt-cap-${index.toString(16)}`,
    household_id: "hh-default",
    title: `Capacity event ${index + 1}`,
    tz: "UTC",
    start_at_utc: start,
    end_at_utc: start + 2_700,
    rrule: undefined,
    exdates: undefined,
    reminder: null,
    created_at: BASE_SECONDS,
...
const noteLinks: NoteLink[] = [
  ...
  },
  {
    ...
    household_id: "hh-default",
    note_id: "note-quick-capture",
    entity_type: "event",
    entity_id: "evt-kickoff",
    relation: "primary",
    created_at: BASE_SECONDS,
    updated_at: BASE_SECONDS,
  },
