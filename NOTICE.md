...
Iconography used across navigation, status, and action controls.

- **Category:** Icons
- **Source:** npm package @fortawesome/fontawesome-free ^6.7.2 — https://fontawesome.com
- **Licenses:** CC-BY-4.0 — Creative Commons Attribution 4.0 International (https://creativecommons.org/licenses/by/4.0/); OFL-1.1 — SIL Open Font License 1.1 (https://scripts.sil.org/OFL)
- **Included via:**
  - src/main.ts — imports @fortawesome/fontawesome-free/css/all.min.css
...
Primary sans-serif typography for interface copy.

- **Category:** Fonts
- **Source:** Upstream download — https://rsms.me/inter/
- **Licenses:** OFL-1.1 — SIL Open Font License 1.1 (https://scripts.sil.org/OFL)
- **Bundled files:**
  - src/assets/fonts/inter/Inter-VariableFont\_slnt,wght.woff2 (Font)
  - src/assets/fonts/inter/Inter-Italic-VariableFont\_slnt,wght.woff2 (Font)
- **Included via:**
  - src/theme.scss — Defines Inter variable font faces for typography.
- **Required attribution:**
