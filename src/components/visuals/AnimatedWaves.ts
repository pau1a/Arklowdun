...
const PATHS_ALT = [
  PATHS[0].replace("424.5C685.7 425", "422.5C685.7 427"),
  PATHS[1].replace("417.3C171.7 413", "415.3C171.7 411"),
  PATHS[2]
    .replace("M0 503", "M0 497")
    .replace(/480\.3/g, "474.3")
    .replace("878.5 496L", "878.5 500.5L"),
  PATHS[3]
    .replace("507.8C43 514.7", "509.8C43 516.7")
    .replace("514.2 491.8C557 497.7", "514.2 489.8C557 495.7"),
  PATHS[4]
    .replace("546.8C43 546.7", "548.0C43 548.2")
    .replace("642.8 567.3C685.7 564.3", "642.8 569.5C685.7 566.3"),
] as const;
